...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    prepareEdit: function prepareEdit(city) {
    ...
    prepareCreate: function prepareCreate() {
    ...
    create: function create() {
      ...
      this.form.post(this.url('cities')).then(function (_ref) {
        var data = _ref.data;

        _this.localCities.unshift(data);
    ...
    update: function update(city) {
      ...
      this.form.patch(this.url('cities/' + city.id)).then(function (_ref2) {
        var data = _ref2.data;

        _this2.cities.splice(_this2.findByIndex(city), 1, data);
    ...
    //     });
    // },
    findByIndex: function findByIndex(city) {
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Governorates.vue?vue&type=script&lang=js&":
/*!***********************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/Governorates.vue?vue&type=script&lang=js& ***!
  \***********************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    prepareEdit: function prepareEdit(governorate) {
    ...
    create: function create() {
      ...
      this.form.post(this.url('governorates')).then(function (_ref) {
        var data = _ref.data;

        _this.governorates.unshift(data);
    ...
    update: function update(governorate) {
      var _this2 = this;

      this.form.patch(this.url('governorates/' + governorate.id)).then(function (_ref2) {
        var data = _ref2.data;

        _this2.governorates.splice(_this2.findByIndex(governorate), 1, data);
    ...
    //     });
    // },
    findByIndex: function findByIndex(governorate) {
...
var render = function() {
  ...
  return _c("div", [
          ...
          "button",
          {
            ...
            on: {
              click: function($event) {
                ...
                return _vm.prepareCreate($event)
              }
            }
          },
          [_vm._v("\n        إنشاء مدينة\n    ")]
                ...
                [
                  _c("div", { staticClass: "modal-body" }, [
                    ...
                    _c(
                      ...
                      [
                            ...
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: _vm.form.governorate_id,
                                expression: "form.governorate_id"
                              }
                            ],
                            staticClass: "form-control",
                            attrs: { name: "governorate_id" },
                            on: {
                          ...
                          _vm._l(_vm.governorates, function(governorate) {
                            return _c("option", {
                              domProps: {
                                ...
                                selected:
                                  _vm.selectedCity &&
                                  _vm.selectedCity.governorate.id ==
                                    governorate.id,
                                textContent: _vm._s(governorate.name)
                              }
                            })
                          }),
                          0
                        ...
                        _vm._v(" "),
                        _c("has-error", {
                          attrs: { form: _vm.form, field: "governorate_id" }
                        })
                      ],
                      1
                    )
                  ...
                  _c("div", { staticClass: "modal-footer" }, [
                    ...
                    _c("button", {
                      ...
                      domProps: { textContent: _vm._s(_vm.modalSubmit) }
                    })
                  ])
                ]
              )
    ...
    _vm._v(" "),
    _vm.governorates.length
      ? _c(
          "table",
          {
            staticClass:
              "table table-hover table-bordered table-center table-active"
          },
          [
            _vm._m(0),
            _vm._v(" "),
            _c(
              "tbody",
              _vm._l(_vm.localCities, function(city, index) {
                return _c("tr", { key: city.id }, [
                  _c("td", { domProps: { textContent: _vm._s(index + 1) } }),
                  _vm._v(" "),
                  _c("td", { domProps: { textContent: _vm._s(city.name) } }),
                  _vm._v(" "),
                  _c("td", {
                    domProps: { textContent: _vm._s(city.governorate.name) }
                  }),
                  _vm._v(" "),
                  _c("td", [
                    _c(
                      "a",
                      {
                        ...
                        on: {
                          click: function($event) {
                            $event.preventDefault()
                            return _vm.prepareEdit(city)
                          }
                        }
                      },
                      [_c("i", { staticClass: "fe fe-edit" })]
                    )
                  ])
                ])
              }),
  ...
  function() {
    ...
    return _c("thead", [
      _c("tr", [
        ...
        _vm._v(" "),
        _c("th", { attrs: { scope: "col" } }, [_vm._v("اسم المدينة")]),
        _vm._v(" "),
        _c("th", { attrs: { scope: "col" } }, [_vm._v("المحاظة")]),
        _vm._v(" "),
        _c("th", { attrs: { scope: "col" } }, [_vm._v("إعدادات")])
      ])
    ])
  }
]
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Governorates.vue?vue&type=template&id=8c8fce7c&":
/*!***************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/Governorates.vue?vue&type=template&id=8c8fce7c& ***!
  \***************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
    ...
    _vm.governorates.length
      ? _c(
          ...
          [
            ...
            _c(
              "tbody",
              _vm._l(_vm.governorates, function(governorate, index) {
                return _c("tr", { key: governorate.id }, [
                  _c("td", { domProps: { textContent: _vm._s(index + 1) } }),
                  _vm._v(" "),
                  _c("td", {
                    domProps: { textContent: _vm._s(governorate.name) }
                  }),
                  _vm._v(" "),
                  _c("td", [
                    _c(
                      "a",
                      {
                        ...
                        on: {
                          click: function($event) {
                            $event.preventDefault()
                            return _vm.prepareEdit(governorate)
                          }
                        }
                      },
                      [_c("i", { staticClass: "fe fe-edit" })]
  ...
  function() {
    ...
    return _c("thead", [
      _c("tr", [
        _c("th", { attrs: { scope: "col" } }, [_vm._v("#")]),
        _vm._v(" "),
        _c("th", { attrs: { scope: "col" } }, [_vm._v("اسم المحافظة")]),
        _vm._v(" "),
        _c("th", { attrs: { scope: "col" } }, [_vm._v("إعدادات")])
      ])
    ])
 ...
 *
 * Eg. ./components/Governorates.vue -> <example-component></example-component>
 */
...
Vue.component('governorates', __webpack_require__(/*! ./components/Governorates.vue */ "./resources/js/components/Governorates.vue")["default"]);
...
/***/ "./resources/js/components/Governorates.vue":
/*!**************************************************!*\
  !*** ./resources/js/components/Governorates.vue ***!
  \**************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Governorates_vue_vue_type_template_id_8c8fce7c___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Governorates.vue?vue&type=template&id=8c8fce7c& */ "./resources/js/components/Governorates.vue?vue&type=template&id=8c8fce7c&");
/* harmony import */ var _Governorates_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Governorates.vue?vue&type=script&lang=js& */ "./resources/js/components/Governorates.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport *//* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _Governorates_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _Governorates_vue_vue_type_template_id_8c8fce7c___WEBPACK_IMPORTED_MODULE_0__["render"],
  _Governorates_vue_vue_type_template_id_8c8fce7c___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/Governorates.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/components/Governorates.vue?vue&type=script&lang=js&":
/*!***************************************************************************!*\
  !*** ./resources/js/components/Governorates.vue?vue&type=script&lang=js& ***!
  \***************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Governorates_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/babel-loader/lib??ref--4-0!../../../node_modules/vue-loader/lib??vue-loader-options!./Governorates.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Governorates.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport */ /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Governorates_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/components/Governorates.vue?vue&type=template&id=8c8fce7c&":
/*!*********************************************************************************!*\
  !*** ./resources/js/components/Governorates.vue?vue&type=template&id=8c8fce7c& ***!
  \*********************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Governorates_vue_vue_type_template_id_8c8fce7c___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib??vue-loader-options!./Governorates.vue?vue&type=template&id=8c8fce7c& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Governorates.vue?vue&type=template&id=8c8fce7c&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Governorates_vue_vue_type_template_id_8c8fce7c___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Governorates_vue_vue_type_template_id_8c8fce7c___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
...
__webpack_require__(/*! C:\xampp\htdocs\blood-bank\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\xampp\htdocs\blood-bank\resources\sass\app.scss */"./resources/sass/app.scss");
